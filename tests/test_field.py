...
class TestField(unittest.TestCase):
    ...
    def test_decode_encode_bool(self):
        ...
        assert (False, b'') == field.decode(0x08, field.encode(False)[1:])
        assert (True, b'') == field.decode(0x08, field.encode(True)[1:])
    ...
    def test_decode_encode_int32(self):
        ...
        for n in numbers:
            assert (n, b'') == field.decode(0x08, field.encode(n)[1:])
